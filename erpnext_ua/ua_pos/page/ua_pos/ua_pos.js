...
frappe.pages["ua-pos"].on_page_load = function (wrapper) {
  ...
  const styles = `<style id="ua-pos-v2-styles">
    ...
    .ua-pos-login-card{width:min(520px,100%);background:#fff;border:1px solid #e4e7ec;border-radius:20px;box-shadow:0 24px 70px rgba(16,24,40,.14);padding:36px}.ua-pos-brand{display:flex;align-items:center;gap:12px}.ua-pos-logo{width:44px;height:44px;border-radius:12px;background:linear-gradient(135deg,#2563eb,#0f766e);display:grid;place-items:center;color:#fff;font-weight:800;font-size:20px}.ua-pos-brand strong{font-size:20px}.ua-pos-brand small{display:block;color:var(--muted);margin-top:2px}.ua-pos-login-card h1{font-size:27px;margin:32px 0 6px;color:var(--ink)}.ua-pos-login-card>p{color:var(--muted);margin:0 0 24px}.ua-pos-field{margin:14px 0}.ua-pos-field label{display:block;font-weight:650;font-size:13px;margin-bottom:7px}.ua-pos-field input,.ua-pos-field select{width:100%;height:48px;border:1px solid #cfd6e2;border-radius:10px;padding:0 14px;outline:0;background:#fff}.ua-pos-field input:focus,.ua-pos-field select:focus{border-color:var(--blue);box-shadow:0 0 0 3px #dbeafe}.ua-pos-login-button{width:100%;height:50px;border:0;border-radius:10px;background:var(--blue);color:#fff;font-weight:750;margin-top:10px}
