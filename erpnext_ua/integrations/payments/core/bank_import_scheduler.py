...
from erpnext_ua.integrations.payments.monobank.scheduler import run_auto_import as mono_auto_import
from erpnext_ua.integrations.payments.privatbank.scheduler import run_auto_import as privat_auto_import
