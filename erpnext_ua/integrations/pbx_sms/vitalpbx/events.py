...
from erpnext_ua.integrations.utils.logger import log_event, sanitize_payload
from erpnext_ua.integrations.utils.security import SALES_ROLES, permitted_doc, require_roles, secrets_equal
...
def webhook_event():
    ...
    if direction == 'inbound':
        try:
            from erpnext_ua.integrations.customer_identification.service import confirm_inbound_call
