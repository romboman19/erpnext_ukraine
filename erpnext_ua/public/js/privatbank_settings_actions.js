  ...
  refresh(frm) {
        ...
        const d0 = new frappe.ui.Dialog({
          ...
          primary_action: async (v0) => {
            ...
            const r = await frappe.call({
              method: "erpnext_ua.integrations.payments.privatbank.service.pb_list_accounts",
            ...
            const d = new frappe.ui.Dialog({
              ...
              primary_action: async (vals) => {
                ...
                await frappe.call({
                  method: "erpnext_ua.integrations.payments.privatbank.service.pb_bind_account",
    ...
    frm.add_custom_button("📥 Тест імпорту (1 день)", async () => {
      try {
        ...
        const r = await frappe.call({
          method: "erpnext_ua.integrations.payments.privatbank.service.pb_statements_import_to_bank_transactions",
