  ...
  refresh(frm) {
        ...
        const pickProfile = new frappe.ui.Dialog({
          ...
          primary_action: async (vals) => {
            ...
            const r = await frappe.call({
              method: "erpnext_ua.integrations.payments.monobank.service.mono_list_accounts",
            ...
            const d = new frappe.ui.Dialog({
              ...
              primary_action: async (values) => {
                ...
                await frappe.call({
                  method: "erpnext_ua.integrations.payments.monobank.service.mono_bind_account",
    ...
    frm.add_custom_button("📥 Тест імпорту (1 день)", async () => {
      try {
        ...
        const r = await frappe.call({
          method: "erpnext_ua.integrations.payments.monobank.service.mono_statements_import_to_bank_transactions",
