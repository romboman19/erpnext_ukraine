...
from erpnext_ua.ecommerce.base.mapping import record_export_hash
...
from erpnext_ua.ecommerce.base.transport.ftp import FileDeliveryTransport
from erpnext_ua.ecommerce.base.transport.http import (
    AmbiguousTransportError,
    HTTPTransport,
)
from erpnext_ua.ecommerce.doctype.ecommerce_file_field.ecommerce_file_field import (
    EcommerceFileField,
)
from erpnext_ua.ecommerce.providers.ocstore import service as ocstore_service
from erpnext_ua.ecommerce.providers.ocstore.xml_orders import parse_order_file
from erpnext_ua.patches.v0_5 import (
    backfill_ecommerce_item_mapping,
    convert_ecommerce_channel_custom_field_to_data,
    move_ecommerce_item_mapping_to_module,
)
from erpnext_ua.patches.v0_6 import register_ecommerce_module_and_sync_mapping


@register_custom_transform("erpnext_ua.tests.integrations.ecommerce.uppercase")
...
class EcommerceBaseTest(unittest.TestCase):
    ...
    def test_custom_transforms_are_code_registered_and_fail_closed(self):
        self.assertEqual(
            apply_export_transform(
                "товар",
                "custom-method-path",
                "erpnext_ua.tests.integrations.ecommerce.uppercase",
            ),
            "ТОВАР",
        )
    ...
    def test_ecommerce_module_registration_patch_is_idempotent(self):
        ...
        self.assertEqual(state["owner"], "erpnext_ua")
