...
from erpnext_consignment_and_commission.consignment_and_commission.adapters.communication import (
    CommunicationAdapter,
    MessagePayload,
    SendResult,
)
from erpnext_consignment_and_commission.consignment_and_commission.adapters.exchange_rate import (
    ExchangeRateAdapter,
    ExchangeRateQuote,
)
from erpnext_consignment_and_commission.consignment_and_commission.adapters.fiscal import (
    FiscalAdapter,
    FiscalDecision,
)
from erpnext_consignment_and_commission.consignment_and_commission.adapters.legal_entity import (
    EntityRef,
    LegalEntityAdapter,
)
from erpnext_consignment_and_commission.consignment_and_commission.adapters.pos import (
    GeneratedDocumentRef,
    POSAdapter,
    POSOrderRef,
)
from erpnext_consignment_and_commission.consignment_and_commission.adapters.printing import (
    PrintingAdapter,
    PrintJob,
)
from erpnext_consignment_and_commission.consignment_and_commission.optional_apps import (
