...
from erpnext_consignment_and_commission.consignment_and_commission.spikes.foundation import (
    CONFIRMATION as FOUNDATION_CONFIRMATION,
)
from erpnext_consignment_and_commission.consignment_and_commission.spikes.foundation import (
    _assert_test_scope as assert_foundation_test_scope,
)
from erpnext_consignment_and_commission.consignment_and_commission.spikes.inventory_dimension import (
    CONFIRMATION,
    _assert_test_scope,
)
