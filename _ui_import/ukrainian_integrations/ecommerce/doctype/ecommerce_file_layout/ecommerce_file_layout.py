...
from ukrainian_integrations.ecommerce.base.serializers.common import encoding
from ukrainian_integrations.ecommerce.base.serializers.xml import validate_xml_name
